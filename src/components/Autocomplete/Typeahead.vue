...
<script>
/* NOTE: This is a modified fork off of the Typeahead component from the uiv library v0.11.10 */
/* Disable ALL ESLint rules for this entire file */
/* eslint-disable */

  // Include dependencies from the unforked uiv library
  import httpUtils from './../../../node_modules/uiv/src/utils/httpUtils'
  import domUtils from './../../../node_modules/uiv/src/utils/domUtils'
  import Dropdown from './../../../node_modules/uiv/src/components/dropdown/Dropdown.vue'
    ...
    methods: {
      prepareItems (data) {
        ...
        for (let i = 0, l = data.length; i < l; i++) {
          ...
          // THIS IS THE LINE THAT IS MODIFIED TO DISABLE LOCAL FILTERING OF RESULTS -SGW
